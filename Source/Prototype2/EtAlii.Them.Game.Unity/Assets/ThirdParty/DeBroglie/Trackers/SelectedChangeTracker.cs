...
namespace DeBroglie.Trackers
{
    ...
    public class SelectedChangeTracker : ITracker
    {
        ...
        private Quadstate GetQuadstateInner(int index)
        {
            ...
            tileModelMapping.GetTileCoordToPatternCoord(index, out var patternIndex, out var _);
        ...
        public void DoBan(int patternIndex, int pattern)
        {
            ...
            {
                foreach (var (_, index, offset) in tileModelMapping.PatternCoordToTileCoordIndexAndOffset.Get(patternIndex))
                {
