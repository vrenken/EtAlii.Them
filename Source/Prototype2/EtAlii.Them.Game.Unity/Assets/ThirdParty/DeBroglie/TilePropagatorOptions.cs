...
namespace DeBroglie
{
    ...
    public class TilePropagatorOptions
    {
        ...
        /// Only used by <see cref="DeBroglie.IndexPickerType.ArrayPriorityMinEntropy"/> and <see cref="DeBroglie.TilePickerType.ArrayPriority"/>
        /// </summary>
        ...
        /// <summary>
        /// Only used by <see cref="DeBroglie.IndexPickerType.Dirty"/>
        /// </summary>
        public ITopoArray<Tile> CleanTiles { get; set; }

        /// <summary>
        /// Only used by <see cref="DeBroglie.IndexPickerType.Ordered"/>
        /// </summary>
